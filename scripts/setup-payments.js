...
async function main() {
  ...
  await valuesUpdate(`'${SHEETS.paymentMethods}'!A1:L5`, [
    ...
    ['crypto_usdt_bep20','crypto','USDT BEP20','USDT BEP20','inactive','USDT','BEP20','0xc93e61979a6a151207094c305c01de5c5e77e0f5','','Inactive method.','Неактивный способ оплаты.','Disabled: current setup uses only TRC20/ERC20.'],
