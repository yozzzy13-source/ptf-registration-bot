...
export async function upsertApplicant(profile) {
  ...
  const patch = {
    ...
    photo_publication_consent: profile.photo_publication_consent || existing?.photo_publication_consent || '',
    photo_consent_at: profile.photo_publication_consent ? nowISO() : (existing?.photo_consent_at || ''),
    notes: profile.notes,
