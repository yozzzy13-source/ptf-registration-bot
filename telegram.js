...
export const ADMIN_COMMAND_LIST = [
  ...
  { cmd:'poster_test',  group:'Матчи', short:'Сгенерировать тестовые постеры', args_en:'[player name]', args:'[имя игрока]',
    short_en:'Generate test posters', help_en:'generate two 9:16 poster variants for the latest confirmed match, or for a match found by player name; images are sent only to the current admin chat', help:'сгенерировать два постера 9:16 для последнего подтверждённого матча или найти матч по имени игрока; изображения придут только в текущий админский чат' },
