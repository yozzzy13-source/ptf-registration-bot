...
export const ADMIN_COMMAND_LIST = [
  ...
  { cmd:'result_test',  group:'Матчи', short:'Предпросмотр карточки результата', args:'[id матча]',
    help:'показать, как карточка и текст уйдут в ленту и в личку, на настоящем матче; никому, кроме вас, не отправляется' },
